...
class Confirm extends StatelessWidget {
  ...
  Confirm({Key key, this.title, this.description, this.action, this.onTap})
      : super(key: key);
    ...
    var content = Column(
      ...
      children: <Widget>[
        ...
        Column(children: <Widget>[
          Text(title,
              style:
                  TextStyle(fontSize: 18.0, fontWeight: Themer().fontBold())),
  ...
  Widget _description() {
    return Container(
      ...
      child: Text(description,
          ...
          style: TextStyle(color: Color(0xAA604B41), fontSize: 14.0)),
    );
  }
  ...
  Widget _options(context) {
    ...
    return Column(
      ...
      children: List<Widget>.from(options.map((o) {
        return Column(
            children: <Widget>[Divider(color: Color(0x16007AFF)), _option(o)]);
      })),
    );
  }
