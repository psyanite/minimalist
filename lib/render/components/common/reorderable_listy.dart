...
/// The callback used by [ReorderableListyView] to move an item to a new
/// position in a list.
///
...
/// [ReorderableListyView] will need to account for this when inserting before
/// [newIndex].
///
...
class ReorderableListyView extends StatefulWidget {
  ...
  /// underlying list.
  ///
  /// This [ReorderableListyView] calls [onReorder] after a list child is dropped
  /// into a new position.
  final ReorderCallback onReorder;

  @override
  _ReorderableListyViewState createState() => _ReorderableListyViewState();
}
...
class _ReorderableListyViewState extends State<ReorderableListyView> {
  // We use an inner overlay so that the dragging list item doesn't draw outside of the list itself.
  final GlobalKey _overlayKey = GlobalKey(debugLabel: '$ReorderableListyView overlay key');
